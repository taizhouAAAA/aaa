	...
	public function other()
	{
		...
		if ($_W['ispost']) {
			...
			if (pdo_get('ewei_shop_exchange_setting', array('uniacid' => $_W)) == false) {
				pdo_insert('ewei_shop_exchange_setting', array('uniacid' => $_W['uniacid'], 'mistake' => $mistake, 'freeze' => $freeze, 'grouplimit' => $grouplimit, 'alllimit' => $alllimit, 'no_qrimg' => (int) $_GPC['no_qrimg']));
			}
			else {
				pdo_update('ewei_shop_exchange_setting', array('mistake' => $mistake, 'freeze' => $freeze, 'grouplimit' => $grouplimit, 'alllimit' => $alllimit, 'no_qrimg' => (int) $_GPC['no_qrimg']), array('uniacid' => $_W['uniacid']));
			}
