<?php defined('IN_IA') or exit('Access Denied');?><div class="mloading-bar" style="margin-top: -31px; margin-left: -140px;"><img src="<?php echo MODULE_URL;?>template/mobile/<?php  echo $template;?>/images/download.gif"><span class="mloading-text">处理中，请稍候...</span></div>
<div id="overlay"></div>
            ...
            <div class="panel-body">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
						...
						<div class="help-block">
                        	该服务卡对应会员等级的有效期，例如30天，即从使用该服务卡开通起，这个会员等级有效期往后加为30天
                        </div>
                    </div>
                </div>
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
						...
						<div class="help-block">
                        	在这个使用有效期之前才可以使用该服务卡，过期后该服务卡未使用也作废处理
                        </div>
                    </div>
                </div>
            </div>
