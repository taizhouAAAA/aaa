	...
	<form action="" method="post" onsubmit="return formcheck(this)">
		<div class="panel panel-default">
				...
				<table class="table">
					<thead>
						<tr>
							...
							<th style="width:10%; text-align:center;">续费会员折扣</th>
							<th style="width:9%; text-align:center;">状态</th>
							<th style="width:12%; text-align:center;">一二三级佣金(%)</th>
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align:center;"><?php  echo $item['level_name'];?></td>
							...
							<td style="text-align:center;"><?php  echo $item['renew_discount'];?>%</td>
							<td style="text-align:center;"><?php echo $item['is_show']==1 ? '显示':'隐藏';?></td>
							<td style="text-align:center;"><?php echo $item['com']['commission1'] ? $item['com']['commission1'].'%' : '空'?>/<?php echo $item['com']['commission2'] ? $item['com']['commission2'].'%' : '空'?>/<?php echo $item['com']['commission3'] ? $item['com']['commission3'].'%' : '空'?></td>
			...
			<div class="panel-footer">
				<a class="btn btn-default" href="<?php  echo $this->createWebUrl('viporder',array('op'=>'vipLevel'));?>"><i class="fa fa-plus"></i> 添加新等级</a>
			</div>
		</div>
	</form>
