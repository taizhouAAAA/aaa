...
<?php  } else if($op=='updateVip') { ?>
	...
	<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('web/viporder/updateVip', TEMPLATE_INCLUDEPATH)) : (include template('web/viporder/updateVip', TEMPLATE_INCLUDEPATH));?>
