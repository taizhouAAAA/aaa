...
<div class="mloading-bar" style="margin-top: -31px; margin-left: -140px;"><img src="<?php echo MODULE_URL;?>template/mobile/<?php  echo $template;?>/images/download.gif"><span class="mloading-text">正在发放优惠券，请稍等...</span></div>
<div id="overlay"></div>
<div class="main">
