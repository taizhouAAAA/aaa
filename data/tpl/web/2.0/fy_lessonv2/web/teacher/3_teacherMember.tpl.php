            ...
            <form action="./index.php" method="get" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2 col-lg-3">
                        <input class="form-control" name="keyword" type="text" value="<?php  echo $_GPC['keyword'];?>" placeholder="昵称/姓名/手机号码">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2 col-lg-3">
                        <input class="form-control" name="teacher_id" type="text" value="<?php  echo $_GPC['teacher_id'];?>">
                    </div>
                    <label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label" style="width:100px;">讲师名称</label>
                    <div class="col-sm-2 col-lg-3">
                        <input class="form-control" name="teacher_name" type="text" value="<?php  echo $_GPC['teacher_name'];?>">
                    </div>
        ...
        <div class="table-responsive panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>[ID: <?php  echo $item['uid'];?>] <?php  echo $item['nickname'];?></td>
