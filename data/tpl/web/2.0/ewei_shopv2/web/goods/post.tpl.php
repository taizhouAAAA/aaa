    ...
    <div class="tabs-container tab-goods">
        <div class="tabs-left">
            <ul class="nav nav-tabs" id="myTab">
				...
				<li <?php  if($item['type'] != 5) { ?>style="display:none;"<?php  } ?>   class="showverifygoods" <?php  if($_GPC['tab']=='verifygoods') { ?>class="active"<?php  } ?> ><a href="#tab_verifygoods"><span style="color: #666;">核销设置</span></a></li>
				<?php  if(com('wxcard')) { ?>
				<li <?php  if($item['type'] != 5) { ?>style="display:none;"<?php  } ?>   class="showverifygoodscard"  <?php  if($_GPC['tab']=='verifygoodscard') { ?>class="active"<?php  } ?> ><a href="#tab_verifygoodscard"><span style="color: #666;">微信会员卡设置</span></a></li>
				<?php  } ?>
            </ul>
