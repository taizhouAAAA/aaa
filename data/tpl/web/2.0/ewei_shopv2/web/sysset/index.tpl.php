...
<div class="page-heading"> <h2>商城设置</h2> </div>
    ...
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">商品图片预览</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('sysset.shop.edit')) { ?>
                <label class="radio-inline"><input type="radio" name="data[close_preview]" value="1" <?php  if(intval($data['close_preview'])==1) { ?>checked=""<?php  } ?>>关闭</label>
