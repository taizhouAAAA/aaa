<?php defined('IN_IA') or exit('Access Denied');?><ul class="we7-page-tab">
	...
	<li <?php  if($do == $active_menu['active'] && strpos($active_menu['url'], $action) !== false) { ?>class="active"<?php  } ?>><a href="<?php  echo $active_menu['url'];?>&version_id=<?php  echo $_GPC['version_id'];?>"><?php  echo $active_menu['title'];?></a></li>
	<?php  } ?>
	<?php  } } ?>
</ul>