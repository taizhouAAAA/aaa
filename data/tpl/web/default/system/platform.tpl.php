...
<div id="js-system-platform" ng-controller="SystemPlatform" ng-cloak>
	<a id="auth" href="<?php  echo $authurl;?>" class="btn btn-primary pull-right we7-margin-bottom " ><i class="fa fa-wechat"></i>微信公众号登录授权</a>
	<div class="clearfix"></div>
	<div class="alert we7-page-alert ">
		开发信息需开放平台审核通过后才可以看到，填写完后才可以使用授权登录功能
	</div>
