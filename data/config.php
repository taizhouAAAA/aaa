...
$config['db']['master']['username'] = 'test_tzjsyttwjl_';
$config['db']['master']['password'] = 'test_tzjsyttwjl_';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'test_tzjsyttwjl_';
...
$config['setting']['authkey'] = '8e73dfec';
